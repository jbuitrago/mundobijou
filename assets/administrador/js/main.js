...
jQuery(document).ready(function(){
    ...
    jQuery('#co_theme_color').css('backgroundColor', '#f55858');
    jQuery('#co_theme_color_1').css('backgroundColor', '#ffc455');
    jQuery('#co_theme_color_2').css('backgroundColor', '#392071');
    jQuery('#co_theme_color_3').css('backgroundColor', '#05d1d4');
});
