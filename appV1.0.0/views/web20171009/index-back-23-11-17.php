                ...
                <div class="row products">
                    ...
                    <?php foreach ($last_prod as $l_p): ?>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                <div class="image" style="height: 200px; width: 200px;"> <a href="<?= base_url(); ?>detalle/<?php echo $l_p->slug; ?>"> <img src="<?= base_url(); ?>uploads/<?php echo $l_p->file1; ?>" alt="" class="img-responsive image1"> </a>
            ...
            <div class="col-sm-12">
                ...
                <div class="row products">
                    <?php foreach ($ofertas as $oferta): ?>
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                <div class="image"  style="height: 200px; width: 200px;"> <a href="<?= base_url(); ?>detalle/<?php echo $oferta->slug; ?>"> <img src="<?= base_url(); ?>uploads/<?php echo $oferta->file1; ?>" alt="" class="img-responsive image1"> </a>
                                    <div class="quick-view-button"> <a href="#" my-link="<?php echo site_url('web/modal_detalle/' . $oferta->slug); ?>" data-toggle="modal" data-target="#product-quick-view-modal" class="btn btn-default btn-sm">Vista rápida</a> </div>
                                </div>
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="<?= base_url(); ?>detalle/<?php echo $oferta->slug; ?>"><?php echo $oferta->titulo; ?>  <?php echo $oferta->articulo; ?></a></h3>
            ...
            <div class="col-sm-12">
                ...
                <div id="blog-homepage" class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <p class="author-category">Horario de atención: Lunes a Viernes de 9:30 a 18 hrs. </p>
                        <hr>
