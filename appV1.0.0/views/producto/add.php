        ...
        <div class="modal-content" style="width: 100%">
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <input type="hidden" value="" name="title_file1"/>
                    <input type="hidden" value="" name="title_file2"/>
                    <input type="hidden" value="" name="title_file3"/>
                    <input type="hidden" value="" name="alt_file1"/>
                    <input type="hidden" value="" name="alt_file2"/>
                    <input type="hidden" value="" name="alt_file3"/>
                    <div class="form-body">
                ...
                <form action="<?= site_url("upload_file/upload_image") ?>" method="post" enctype="multipart/form-data" id="MyUploadForm1">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input name="title_c1" class="form-control" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input name="alt_c1" class="form-control" type="text">
                            </div>
                ...
                <form action="<?= site_url("upload_file/upload_image") ?>" method="post" enctype="multipart/form-data" id="MyUploadForm2">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-md-3">Title</label>
                            <div class="col-md-4">
                                <input name="title_c2" class="form-control" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-md-3">Alt</label>
                            <div class="col-md-4">
                                <input name="alt_c2" class="form-control" type="text">
                            </div>
                ...
                <form action="<?= site_url("upload_file/upload_image") ?>" method="post" enctype="multipart/form-data" id="MyUploadForm3">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-md-3">Title</label>
                            <div class="col-md-4">
                                <input name="title_c3" class="form-control" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-md-3">Alt</label>
                            <div class="col-md-4">
                                <input name="alt_c3" class="form-control" type="text">
                            </div>
...
<script>
    ...
    function edit_obj(id)
    {
        ...
        $.ajax({
            ...
            success: function (data)
            {
                ...
                $('[name="title_file1"]').val(data.title_file1);
                $('[name="title_file2"]').val(data.title_file2);
                $('[name="title_file3"]').val(data.title_file3);
                
                $('[name="alt_file1"]').val(data.alt_file1);
                $('[name="alt_file2"]').val(data.alt_file2);
                $('[name="alt_file3"]').val(data.alt_file3);
                
                $('[name="title_c1"]').val(data.title_file1);
                $('[name="title_c2"]').val(data.title_file2);
                $('[name="title_c3"]').val(data.title_file3);
                
                $('[name="alt_c1"]').val(data.alt_file1);
                $('[name="alt_c2"]').val(data.alt_file2);
                $('[name="alt_c3"]').val(data.alt_file3);
    ...
    $('[name="title_c1"]').change(function () {

        $('[name="title_file1"]').val($('[name="title_c1"]').val());

    });

    $('[name="title_c2"]').change(function () {

        $('[name="title_file2"]').val($('[name="title_c2"]').val());

    });

    $('[name="title_c3"]').change(function () {

        $('[name="title_file3"]').val($('[name="title_c3"]').val());

    });

    $('[name="alt_c1"]').change(function () {

        $('[name="alt_file1"]').val($('[name="alt_c1"]').val());

    });

    $('[name="alt_c2"]').change(function () {

        $('[name="alt_file2"]').val($('[name="alt_c2"]').val());

    });

    $('[name="alt_c3"]').change(function () {

        $('[name="alt_file3"]').val($('[name="alt_c3"]').val());
