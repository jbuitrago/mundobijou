    ...
    function edit_obj(id)
    {
        ...
        $.ajax({
            ...
            success: function (data)
            {
                ...
                $('[name="email_contacto"]').val(data.email_contacto);
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input name="smtp_host" placeholder="smtp host" class="form-control" type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input name="smtp_email_from" placeholder="smtp email from" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-4">Smtp email name</label>
                            <div class="col-md-8">
                                <input name="smtp_email_name" placeholder="smtp email name" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-4">Smtp email pass</label>
                            <div class="col-md-8">
                                <input name="smtp_email_pass" placeholder="smtp email pass" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-4">Email envio quiebre</label>
                            <div class="col-md-8">
                                <input name="email_envio_quiebre" placeholder="email envio quiebre" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-4">Email envio pedido</label>
                            <div class="col-md-8">
                                <input name="email_envio_pedido" placeholder="email envio pedido" class="form-control" type="text">
                            </div>
                        </div>
                        
                         <div class="form-group">
                            <label class="control-label col-md-4">Email contacto</label>
                            <div class="col-md-8">
                                <input name="email_contacto" placeholder="email contacto" class="form-control" type="text">
                            </div>
                        </div>
