    ...
    <script>
        ...
        function ajaxindicatorstart(text)
        {
            if (jQuery('body').find('#resultLoading').attr('id') != 'resultLoading') {
                jQuery('body').append('<div id="resultLoading" style="display:none"><div><img src="<?= base_url() ?>assets/web/img/ajax-loader_1.gif"><div>' + text + '</div></div><div class="bg"></div></div>');
            }
