                ...
                <div class="col-sm-9 col-sm-push-3">
                                    ...
                                    <form class="form-inline">
                                        <div class="col-md-6 col-sm-6">
                                            <div class="products-number"> <strong>Mostrar</strong> 
                                                <a href="<?= base_url(); ?><?= str_replace(' ', '-', $categoria_actual) ?>/<?= str_replace(' ', '-', $subcategoria_actual) ?>/<?= (($sort == 'precio_mayorista')and ( $order == 'desc')) ? $sort . '_' . $order : $sort ?>/<?=$filtro?>/12/<?= 1 ?>" class="btn btn-default btn-sm <?= ($per_page == 12) ? 'btn-primary' : '' ?>">12</a> 
                                                <a href="<?= base_url(); ?><?= str_replace(' ', '-', $categoria_actual) ?>/<?= str_replace(' ', '-', $subcategoria_actual) ?>/<?= (($sort == 'precio_mayorista')and ( $order == 'desc')) ? $sort . '_' . $order : $sort ?>/<?=$filtro?>/24/<?= 1 ?>" class="btn btn-default btn-sm <?= ($per_page == 24) ? 'btn-primary' : '' ?>">24</a> 
                                                <a href="<?= base_url(); ?><?= str_replace(' ', '-', $categoria_actual) ?>/<?= str_replace(' ', '-', $subcategoria_actual) ?>/<?= (($sort == 'precio_mayorista')and ( $order == 'desc')) ? $sort . '_' . $order : $sort ?>/<?=$filtro?>/99999999/<?= 1 ?>" class="btn btn-default btn-sm <?= ($per_page == 99999999) ? 'btn-primary' : '' ?>">Todos</a> 
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                    ...
                    <div class="row products">
                        ...
                        <div class="pages">
                            ...
                            <div class="banner"> <a href="https://docs.google.com/forms/d/e/1FAIpQLSdhMvpetAdFfSZSApQleZK3LQRPzcP4zw6qwPWgHKd50mIisA/viewform"> <img src="<?= base_url(); ?>assets/web/img/banner2.jpg" alt="" class="img-responsive"> </a> </div>
