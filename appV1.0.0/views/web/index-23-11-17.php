...
<div id="all">
    <div id="content">
                ...
                <div class="row products">
                    ...
                    <?php foreach ($last_prod as $l_p): ?>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                <div class="image" style="height: 200px; width: 200px;"> <a href="<?php echo site_url(strtolower(str_replace(' ', '-', $l_p->categoria)) . '/' . str_replace(' ', '-', $l_p->titulo) . '-' . str_replace(' ', '-', $l_p->articulo) . '-' . $l_p->id); ?>"> <img src="<?= base_url(); ?>uploads/<?php echo $l_p->file1; ?>" alt="" class="img-responsive image1"> </a>
                                    <div class="quick-view-button"> <a href="#" my-link="<?php echo site_url('web/modal_detalle/'.strtolower(str_replace(' ', '-', $l_p->categoria)) . '/' . str_replace(' ', '-', $l_p->titulo) . '-' . str_replace(' ', '-', $l_p->articulo) . '-' . $l_p->id); ?>" data-toggle="modal" data-target="#product-quick-view-modal" class="btn btn-default btn-sm">Vista rápida</a> </div>
                                </div>
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="<?php echo site_url(strtolower(str_replace(' ', '-', $l_p->categoria)) . '/' . str_replace(' ', '-', $l_p->titulo) . '-' .str_replace(' ', '-',  $l_p->articulo) . '-' . $l_p->id); ?>"><?php echo $l_p->titulo; ?>  <?php echo $l_p->articulo; ?></a></h3>
            ...
            <div class="col-sm-12">
                ...
                <div class="row products">
                    <?php foreach ($ofertas as $oferta): ?>
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                <div class="image"  style="height: 200px; width: 200px;"> <a href="<?php echo site_url(strtolower(str_replace(' ', '-', $oferta->categoria)) . '/' . str_replace(' ', '-', $oferta->titulo) . '-' . str_replace(' ', '-', $oferta->articulo) . '-' . $oferta->id); ?>"> <img src="<?= base_url(); ?>uploads/<?php echo $oferta->file1; ?>" alt="" class="img-responsive image1"> </a>
                                    <div class="quick-view-button"> <a href="#" my-link="<?php echo site_url('web/modal_detalle/' .strtolower(str_replace(' ', '-', $oferta->categoria)) . '/' . str_replace(' ', '-', $oferta->titulo) . '-' . str_replace(' ', '-', $oferta->articulo) . '-' . $oferta->id); ?>" data-toggle="modal" data-target="#product-quick-view-modal" class="btn btn-default btn-sm">Vista rápida</a> </div>
                                </div>
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="<?php echo site_url(strtolower(str_replace(' ', '-', $oferta->categoria)) . '/' . str_replace(' ', '-', $oferta->titulo) . '-' . str_replace(' ', '-', $oferta->articulo) . '-' . $oferta->id); ?>"><?php echo $oferta->titulo; ?>  <?php echo $oferta->articulo; ?></a></h3>
        ...
        <div class="container">
            <div class="col-sm-12">
                <div class="box text-center">
                    <h3 class="text-uppercase">Dónde estamos</h3>
                </div>
