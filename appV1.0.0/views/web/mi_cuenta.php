         ...
         _________________________________________________________ -->
            ...
            <div class="col-md-9 clearfix" id="customer-account">
                ...
                <div class="box clearfix">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h4 class="inline">Tipo de cuenta <span style="color:red">(*)</span>: </h4>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="rs">Nombre y Apellido / Razón Social <span style="color:red">(*)</span></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="cuit">CUIT / CUIL / DNI <span style="color:red">(*)</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="phone">Código de Área + Teléfono <span style="color:red">(*)</span></label>
