                    ...
                    <div class="box">
                        ...
                        <div class = "table-responsive">
                            <table class = "table">
                                ...
                                <tbody>
                                    ...
                                    foreach ($cart_check as $item):
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo site_url($this->cart->product_options($item['rowid'])['my_url']); ?>"> <img src="<?= base_url(); ?>uploads/<?= $this->cart->product_options($item['rowid'])['imagen'] ?>" alt="White Blouse Armani"> </a></td>
                                            <td><a href="<?php echo site_url($this->cart->product_options($item['rowid'])['my_url']); ?>" class="black"><?php echo $item['name']; ?></a></td>
                                            <td>
                                                <?php
                                                $data = array(
                                                    'name' => 'cart[' . $item['rowid'] . '][qty]',
                                                    'id' => 'cart[' . $item['rowid'] . '][qty]',
                                                    'class' => 'form-control',
                                                    'type' => 'number',
                                                    'value' => $item['qty'],
                                                    'onchange' => '$(\'#form_carro\').submit()',
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align: center;"><?=(!empty($_SESSION['descuento_aplicado']['porcentaje'])) ? '('.$_SESSION['descuento_aplicado']['codigo_descuento'].') ' : ''?>$<?= number_format($descuento, 2, '.', '') ?></th>
                                        <th>&nbsp;</th>
                                    </tr>
                                    <tr>
                            ...
                            <div class="alert alert-dismissible alert-info" role="alert">
                                ...
                                Pedido y stock a verificar en base a disponibilidad de productos. Los precios incluyen IVA.</div>
                        </div>
                        <!-- /.table-responsive -->

                        <div class="box-footer">
                            <div class="pull-left"> <a href="<?php echo site_url((!empty($_SESSION['last_url_view'])) ? $_SESSION['last_url_view'] : 'productos'); ?>" class="btn btn-primary invert"><i class="fa fa-chevron-left"></i> Seguir comprando</a> </div>
                            <div class="pull-right">
                                <button class="btn btn-default" type="submit"><i class="fa fa-refresh"></i> Actualizar carro</button>
                                <?php //submit button.     ?>

                                <?php echo form_close(); ?>
                                <a  href="<?php echo site_url('checkout1'); ?>" class="btn btn-primary invert">Avanzar<i class="fa fa-chevron-right"></i> </a> </div>
                        </div>
