                ...
                <div class="row" id="productMain">
                    <div class="col-sm-6">
                        ...
                        <div class="row" id="thumbs">
                            <?php if (!empty($producto->file1)): ?> <div class="col-xs-4"> <a href="<?= base_url(); ?>uploads/<?= $producto->file1 ?>" class="thumb"> <img src="<?= base_url(); ?>uploads/<?= $producto->file1 ?>" alt="<?=$producto->alt_file1?>" title="<?=$producto->title_file1?>" class="img-responsive"> </a> </div><?php endif; ?>
                            <?php if (!empty($producto->file2)): ?> <div class="col-xs-4"> <a href="<?= base_url(); ?>uploads/<?= $producto->file2 ?>" class="thumb"> <img src="<?= base_url(); ?>uploads/<?= $producto->file2 ?>" alt="<?=$producto->alt_file2?>" title="<?=$producto->title_file2?>" class="img-responsive"> </a> </div><?php endif; ?>
                            <?php if (!empty($producto->file3)): ?> <div class="col-xs-4"> <a href="<?= base_url(); ?>uploads/<?= $producto->file3 ?>" class="thumb"> <img src="<?= base_url(); ?>uploads/<?= $producto->file3 ?>" alt="<?=$producto->alt_file3?>" title="<?=$producto->title_file2?>" class="img-responsive"> </a> </div><?php endif; ?>
                    ...
                    <div class="col-sm-6">
                        <div class="box noborder">
                            ...
                            echo form_hidden('my_url', strtolower($producto->categoria) . '/' . $producto->titulo . '-' . $producto->articulo . '-' . $producto->id);

                            echo form_hidden('cantidad_a_descontar', 1);
                            ?>

                            <?php
                                    $cantidad_talles = count($talles);

                                    if ($cantidad_talles > 0):
                            ?>
                                ...
                                <div class="sizes">
                                    ...
                                    <?php foreach ($talles as $talle): ?>
                                        ...
                                        <label for="size_s"> <a href="#"><?= $talle->nombre; ?></a>
                                            <?php if($cantidad_talles == 1): ?>
                                            <input type="radio" id="size_s" name="size" value="<?= $talle->talle_id ?>" class="size-input" checked="">
                                            <?php else: ?>
                                ...
                                <div class="colours">
                                    ...
                                    <?php foreach ($colores as $color): ?>
                                        ...
                                        <div class="radio radio-<?= $color->color_id ?> radio-inline">
                                            <?php if($cantidad_colores == 1): ?>
                                            <input type="radio" id="inlineRadio<?= $color->color_id ?>" value="<?= $color->color_id ?>" name="color_id" checked="">
                                            <?php else:?>    
...
<!--<a href="#" class="external twitter" data-animate-hover="pulse"><i class="fa fa-twitter"></i></a> -->
                 ...
                 <div class="banner hidden-lg hidden-md"> <a href="<?php echo site_url('index'); ?>"> <img src="<?= base_url(); ?>assets/web/img/banner.jpg" alt="Mundo Bijou" class="img-responsive"> </a> </div>

                            <div class="banner hidden-lg hidden-md"> <a href="<?php echo site_url('index'); ?>"> <img src="<?= base_url(); ?>assets/web/img/banner3.jpg" alt="Mundo Bijou" class="img-responsive"> </a> </div>

                            <div class="banner hidden-lg hidden-md"> <a href="<?php echo site_url('index'); ?>"> <img src="<?= base_url(); ?>assets/web/img/banner4.jpg" alt="Mundo Bijou" class="img-responsive"> </a> </div>
            ...
            <div class="col-sm-3 col-sm-pull-9">
                                ...
                                <li class="parent">
                                    ...
                                    <?php if ($c->total > 0): ?>    
                                        ...
                                        <ul class="child">
                                            ...
                                            <?php echo '<li><a href="' . base_url() . $c->nombre . '-' . $c->id . '/">Todos </a></li>'; ?>
                ...
                <!-- *** MENUS AND FILTERS END *** -->
                    ...
                    <div class="banner hidden-sm hidden-xs"> <a href="<?php echo site_url('index'); ?>"> <img src="<?= base_url(); ?>assets/web/img/banner.jpg" alt="Mundo Bijou" class="img-responsive"> </a> </div>

                    <div class="banner hidden-sm hidden-xs"> <a href="<?php echo site_url('index'); ?>"> <img src="<?= base_url(); ?>assets/web/img/banner3.jpg" alt="Mundo Bijou" class="img-responsive"> </a> </div>

                    <div class="banner hidden-sm hidden-xs"> <a href="<?php echo site_url('index'); ?>"> <img src="<?= base_url(); ?>assets/web/img/banner4.jpg" alt="Mundo Bijou" class="img-responsive"> </a> </div>
                    <!-- /.banner -->
