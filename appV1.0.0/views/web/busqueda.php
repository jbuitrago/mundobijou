        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <div class="banner"> <a href="<?php echo site_url('productos'); ?>"> <img src="<?= base_url(); ?>assets/web/img/banner.jpg" alt="Mundo Bijou" class="img-responsive"> </a> </div>
                    ...
                    <div class="banner"> <a href="<?php echo site_url('productos'); ?>"> <img src="<?= base_url(); ?>assets/web/img/banner4.jpg" alt="Mundo Bijou" class="img-responsive"> </a> </div>
                    <!-- /.banner -->
                ...
                <div class="col-sm-9">
                    ...
                    <div class="row products">
                        ...
                        <?php foreach ($productos as $producto): ?>
                            ...
                            // str_replace(' ', '-', site_url(strtolower(str_replace(' ', '-', $producto->categoria)) . '/' . str_replace(' ', '-', $producto->titulo) . '-' . str_replace(' ', '-', $producto->articulo) . '-' . $producto->id))
                            
                         $pagina = (!empty($producto->composicion)) ? 'detalle_combo/' . $producto->slug : strtolower(str_replace(' ', '-', $producto->categoria)) . '/' . str_replace(' ', '-', $producto->titulo) . '-' . str_replace(' ', '-', $producto->articulo) . '-' . $producto->id;

                            $pagina_modal = (!empty($producto->composicion)) ? 'modal_detalle_combo/' . $producto->slug : 'modal_detalle/' . strtolower(str_replace(' ', '-', $producto->categoria)) . '/' . str_replace(' ', '-', $producto->titulo) . '-' . str_replace(' ', '-', $producto->articulo) . '-' . $producto->id;
                            ?>
                                ...
                                <div class="col-md-3 col-sm-4">
                                    ...
                                    <div class="product" id="producto_<?= $producto->id ?>">
                                        <div class="image" style="height: 180px;"> 
                                            <a href="<?php echo site_url($pagina); ?>"> 
                                                <img src="<?= base_url() . 'uploads/' . $producto->file1; ?>" alt="<?= $producto->titulo ?> art.<?= $producto->articulo ?>" class="img-responsive image1"> 
                                            </a>
                                            <div class="quick-view-button"> <a href="#" my-link="<?php echo site_url('web/' . $pagina_modal); ?>" data-toggle="modal" data-target="#product-quick-view-modal" class="btn btn-default btn-sm">Vista rápida</a> </div>
                                        </div>
                                        <!-- /.image -->
                                        <div class="text">
                                            <h3><a href="<?php echo site_url($pagina); ?>"><?= $producto->titulo ?> art.<?= $producto->articulo ?></a></h3>
                                            <p class="description"><?= $producto->descripcion_corta ?></p>
                                            <p class="price">$<?= ($tipo_cliente == 2) ? number_format($producto->precio_revendedor * $valor_dolar, 2, '.', '') : number_format($producto->precio_mayorista * $valor_dolar, 2, '.', '') ?></p>
                                            <p class="text-center">
                                                <a href="<?php echo site_url($pagina); ?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> Comprar</a>
                                                <br><br>

                                                <a href="<?php echo site_url($pagina); ?>"><i class="fa fa-external-link-square" aria-hidden="true"></i> VER DETALLE</a></p>
                                        </div>
                                        <!-- /.text -->
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 banner"> <a href="https://docs.google.com/forms/d/e/1FAIpQLSdhMvpetAdFfSZSApQleZK3LQRPzcP4zw6qwPWgHKd50mIisA/viewform"> <img src="<?= base_url(); ?>assets/web/img/banner2.jpg" alt="" class="img-responsive"> </a> </div>
                        </div>
                        <div class="pages">
                            <ul class="pagination">
