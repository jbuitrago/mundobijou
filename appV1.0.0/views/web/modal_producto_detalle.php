            ...
            <div class="row quick-view product-main">
                <div class="col-sm-6">
                    ...
                    <div class="row" id="thumbs">
                        ...
                        <?php if (!empty($producto->file3)): ?> <div class="col-xs-4"> <a href="<?= base_url(); ?>uploads/<?= $producto->file3 ?>" class="thumb"> <img src="<?= base_url(); ?>uploads/<?= $producto->file3 ?>" alt="<?=$producto->alt_file3?>" title="<?=$producto->title_file3?>" class="img-responsive"> </a> </div><?php endif; ?>
                                ...
                                <?php foreach ($colores as $color): ?>
                                    ...
                                    <style>
                                        ...
                                        .radio-<?= $color->color_id ?> input[type="radio"]:checked + label::before {
                                            ...
                                            border-color: #444 /*rgba(211,211,211,1)*/;
                                        }
