        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-xs-2 ">
                    <div class="call-us"> 
                        <a href="tel:01143821379" class="hidden-xs blanco" >
                            <i class="fa fa-phone" aria-hidden="true"></i> 
                            <span class="hidden-sm hidden-xs">(011) 4382.1379 / 6088.7172</span>
                        </a> 
                        <a href="tel:0112777-0109" class="verde" >
                            <i class="fa fa-whatsapp" aria-hidden="true"></i>
                            <span class="hidden-sm hidden-xs">(011) 2777-0109</span>
                        </a> 
                        <a href="<?= base_url(); ?>red_vendedores" class="blanco" >
                            
                            <span class="hidden-sm hidden-xs">Red vendedores</span>
                        </a> 
                        <a href="<?= base_url(); ?>contacto" class="blanco" >
                            <i class="fa fa-envelope" aria-hidden="true"></i> 
                            <span class="hidden-sm hidden-xs">Contacto</span>
                        </a> 
                        <a href="<?= base_url(); ?>index" class="blanco" >
