                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="<?php echo site_url($this->cart->product_options($item['rowid'])['my_url']); ?>"> <img src="<?= base_url(); ?>uploads/<?= $this->cart->product_options($item['rowid'])['imagen'] ?>" alt="<?= $this->cart->product_options($item['rowid'])['slug']; ?>"> </a></td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th style="text-align: center;">$<?php echo number_format($subtotal, 2, '.', ''); ?></th>
                                        <th>&nbsp;</th>
                                    </tr>
                                    <tr>
