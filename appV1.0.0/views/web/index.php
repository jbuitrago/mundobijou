        ...
        <div class="container">
            <div class="col-sm-12">
                <div class="box text-center">
                    ...
                    <a href="<?php echo site_url('productos/0/0/precio_mayorista/nuevos'); ?>" class="btn btn-default btn-sm"><small>VER TODOS</small></a> </div>
            ...
            <div class="col-sm-12">
                <div class="box text-center">
                    ...
                    <a href="<?php echo site_url('productos/0/0/precio_mayorista/ofertas'); ?>" class="btn btn-default btn-sm"><small>VER TODAS</small></a> </div>
                <div class="row products">
