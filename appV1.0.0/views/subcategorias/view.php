...
<script type="text/javascript">
    ...
    function edit_obj(id)
    {
        ...
        $.ajax({
            ...
            {
                $('[name="id"]').val(data.id);
                $('[name="categoria_padre"]').val(data.categoria_padre);
                $('[name="nombre"]').val(data.nombre);
                $('[name="destacada"]').val(data.destacada);
                $('[name="metadescripcion"]').val(data.metadescripcion);
                ...
                if (data.foto != null)
                    $('#output').html('<img src="' + base_url + 'uploads/' + data.foto + '" style="width:50px;">');
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
               ...
               <form action="<?= $controller ?>/ExcelDataAdd" onsubmit="return validar()" enctype="multipart/form-data" method="post" accept-charset="utf-8" >   
                ...
                <button type="submit"  ONCLICK="document.location='uploads/modelos/subcategoria.xlsx'" id="btnSave" class="btn btn-primary">Bajar formato</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Categoria padre</label>
                            <div class="col-md-9">
                                <?php echo form_dropdown('categoria_padre', $categorias, '', 'class="form-control" id="categoria_padre"'); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Nombre</label>
                            <div class="col-md-9">
                                <input name="nombre" placeholder="Ingrese un nombre" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Metadescripcion</label>
                            <div class="col-md-9">
                                <textarea name="metadescripcion" placeholder="metadescripcion" class="form-control"></textarea>
                            </div>
                        </div>
