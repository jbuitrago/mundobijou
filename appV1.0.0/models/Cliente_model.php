...
class cliente_model extends Default_model {
    ...
    var $table = 'cliente';
    var $column = array('cliente.id','nombre_apellido','usuario','email','provincia.nombre AS provincia','localidad.nombre AS localidad','tipo_cliente.nombre AS tipo_cliente', 'cliente.fecha_insert');
    ...
    function login($username, $password) {
       // $this->db->select(implode(',', $this->column));
        ...
        $this->db->where('(usuario = ' . "'" . $username . "' or email = '".$username."' ) ");
