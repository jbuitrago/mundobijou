...
class Web extends MY_Controller {
    ...
    public function productos() {
        ...
        $page_number = ($this->uri->segment(6 - $to_rest_segment)) ? $this->uri->segment(6 - $to_rest_segment) : 1;
    ...
    private function get_config_pagination($categoria, $sub_categoria, $page = 'productos') {
        ...
        $config["per_page"] = (!empty($this->uri->segment(5 - $to_rest_segment))) ? $this->uri->segment(5 - $to_rest_segment) : '12';

        $config['uri_segment'] = 6 - $to_rest_segment;
    ...
    private function contruct_uri() {
        ...
        $page = (!empty($this->uri->segment(6 - $to_rest_segment))) ? $this->uri->segment(6 - $to_rest_segment) : '1';

        $per_page = (!empty($this->uri->segment(5 - $to_rest_segment))) ? $this->uri->segment(5 - $to_rest_segment) : '12';
