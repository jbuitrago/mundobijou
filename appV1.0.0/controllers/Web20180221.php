...
class Web extends MY_Controller {
    ...
    public function productos() {
        ...
        if ($this->uri->segment(5 - $to_rest_segment) != '') {
    ...
    private function get_config_pagination($categoria, $sub_categoria, $page = 'productos') {
        ...
        if ($page == 'productos') {
            $config["total_rows"] = $this->producto->record_count($categoria, $sub_categoria, $this->uri->segment(5));
        } else {
            $config["total_rows"] = $this->combo->record_count($categoria, $sub_categoria, $this->uri->segment(5));
        }
    ...
    private function contruct_uri() {
        ...
        $filtro = (!empty($this->uri->segment(5 - $to_rest_segment))) ? $this->uri->segment(5 - $to_rest_segment) : '';
