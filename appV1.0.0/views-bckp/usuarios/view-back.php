                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nombre" placeholder="Nombre" class="form-control" type="text" maxlength="45" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="apellido" placeholder="Apellido" class="form-control" type="text" maxlength="45" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="usuario" placeholder="Usuario" class="form-control" type="text" maxlength="20" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="password" placeholder="Password" class="form-control" type="password" maxlength="20" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="email" placeholder="Email" class="form-control" type="email" maxlength="45" required="required">
                            </div>
                        </div>
                        <div class="form-group">
