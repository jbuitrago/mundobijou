...
<script type="text/javascript">
    ...
    function ver_permisos(rol_id) {
        ...
        $("#listado_pedidos").load("<?php echo site_url($controller . '/get_permisos') ?>/" + rol_id, function () {
...
<div class="modal fade" id="modal_pedidos" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title2">Permisos</h3>
            </div>
            <div class="modal-body" id='listado_pedidos' style="height: 450px; overflow: auto;">
