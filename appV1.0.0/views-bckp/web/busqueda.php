                ...
                <div class="col-sm-9">
                    ...
                    <div class="row products">
                        ...
                        <?php foreach ($productos as $producto): ?>
                            ...
                            $pagina = (!empty($producto->composicion))? 'detalle_combo/' . $producto->slug : strtolower($producto->categoria) . '/' . $producto->titulo . '-' . $producto->articulo . '-' . $producto->id;
                            
                            $pagina_modal = (!empty($producto->composicion))? 'modal_detalle_combo/'.$producto->slug : 'modal_detalle/'.strtolower($producto->categoria) . '/' . $producto->titulo . '-' . $producto->articulo . '-' . $producto->id;
                            ...
                            <?php if ($indice == 0): ?><div class="row products"><?php endif; ?>
                                ...
                                <div class="col-md-3 col-sm-4">
                                    ...
                                    <div class="product" id="producto_<?= $producto->id ?>">
                                        <div class="image" style="height: 180px;"> <a href="<?php echo site_url($pagina); ?>"> <img src="<?= base_url() . 'uploads/' . $producto->file1; ?>" alt="<?= $producto->titulo ?> art.<?= $producto->articulo ?>" class="img-responsive image1"> </a>
