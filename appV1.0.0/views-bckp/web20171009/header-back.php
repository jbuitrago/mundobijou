        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-xs-2 ">
                    <div class="call-us"> <a href="tel:01143821379" class="hidden-xs blanco" ><i class="fa fa-phone" aria-hidden="true"></i> <span class="hidden-sm hidden-xs">(011) 4382.1379 / 6088.7172</span></a> <a href="tel:01143821379" class="blanco" ><i class="fa fa-whatsapp" aria-hidden="true"></i> <span class="hidden-sm hidden-xs">(011) 4382.1379 / 6088.7172</span></a> <a href="<?= base_url(); ?>contacto" class="blanco" ><i class="fa fa-envelope" aria-hidden="true"></i> <span class="hidden-sm hidden-xs">Contacto</span></a> </div>
                </div>
                <div class="col-sm-6 col-xs-10 ">
                    <div class="top-link clearfix">
                        <ul class="link f-right" style="list-style-type: none;">
                            <?php if(empty($cliente_logged)):?><li> <a href="#" data-toggle="modal" data-target="#login-modal"> <i class="fa fa-lock" aria-hidden="true"></i> Login </a> </li> <?php endif; ?>
        ...
        <div class="navbar-collapse collapse" id="navigation">
            ...
            <ul class="nav navbar-nav ">
                ...
                foreach ($categorias as $c):
                    ...
                    if ($c->total == 0):
                        ?>
                        <li > <a href="<?= base_url(); ?>productos/<?php echo $c->id; ?>" ><?php echo $c->nombre; ?><b class="caret"></b></a>

                        <?php else: ?>   
                            <li class="dropdown yamm-fw"> <a href="<?= base_url(); ?>productos/<?php echo $c->id; ?>" class="dropdown-toggle" data-toggle="dropdown"><?php echo $c->nombre; ?><b class="caret"></b></a>
                        <?php endif; ?>       
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                                        ...
                                                        if ($c->id == $sub->categoria_padre):
                                                            if ($sub->foto != null):
                                                                if ($count > 0):
                                                                    ...
                                                                    $count++;
                                                                    ?>
                                                                    <div class="item active"> <img src="<?= base_url(); ?>uploads/<?php echo $sub->foto; ?> "> </div>
                                                                <?php
                                                                endif;
                                                            endif;
                                                        endif;
                                                ...
                                                foreach ($subcategorias as $sub):
                                                    if ($c->id == $sub->categoria_padre) :
                                                        if ($cant < 7):
                                                            ...
                                                            <li><a href="<?= base_url(); ?>productos/<?=$sub->categoria_padre ?>/<?=$sub->id?>"><?php echo $sub->nombre; ?></a> </li>
                                                            <?php
                                                            $cant++;
                                                        else:
                                                            ?>
                                ...
                                <div class="footer clearfix hidden-xs"> <a href="<?= base_url(); ?>productos/<?php echo $c->id; ?>">
