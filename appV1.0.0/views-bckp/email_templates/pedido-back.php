...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <span class="preheader">Gracias por comprar en Mundo  Bijou.</span>
                                ...
                                <table class="email-body_inner" align="center" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="content-cell">
                                            <h1>Gracias por comprar en Mundo  Bijou</h1>
                                                ...
                                                <tr>
                                                    <td class="attributes_content">
                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td class="attributes_item"><strong>#<?= str_pad($pedido->id, 4, 0, STR_PAD_LEFT) ?></strong></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="attributes_item"><strong>Total: $<?php echo number_format($pedido->total, 2); ?></strong></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="attributes_item"><strong>Fecha: <?= date("d/m/Y", strtotime($pedido->fecha_insert)) ?></strong></td>
                                                            </tr>
                                                            
                                                            <tr>
                                                                <td class="attributes_item"><strong>Forma de pago: <?= $pedido->forma_pago ?></strong></td>
                                                            </tr>
                                                            
                                                            <tr>
                                                                <td class="attributes_item"><strong>Cliente:  <?= $cliente->nombre_apellido ?></strong>
                                                                    <p>
                                                             
                                                                        <b>Doc.:</b> <?= $cliente->numero_doc ?><br>
                                                                        <b>Tipo cuenta:</b> <?= ($cliente->tipo_cliente == 1)?'Mayorista': 'Revendedor'?>
                                                            ...
                                                            <tr>
                                                                <td class="attributes_item"><strong>Direcci&oacute;n de entrega:</strong>
                                                                    <p>
                                                                        <b>Calle:</b> <?= $pedido->calle ?> <b>N&deg;:</b> <?= $pedido->altura ?> - <?= $pedido->piso ?>&nbsp;<?= $pedido->dpto ?> <br>
                                                                        <b>Barrio:</b> <?= $pedido->barrio ?> - <b>Manzana</b> <?= $pedido->manzana ?> - <b>Lote</b> <?= $pedido->lote ?> - <b>CP</b> <?= $pedido->codigo_postal ?><br>
                                                                        <b>Provincia:</b><?= $extra['provincias'][$pedido->provincia] ?> - <b>Localidad:</b> <?= $extra['localidades'][$pedido->localidad] ?><br>
                                                                        <b>Expreso:</b> <?= $pedido->expreso ?><br>
                                                                       <b>Comentario:</b> <?= $pedido->comentario ?></p>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td>
                                                                                <a href="<?php echo site_url('link/'.$pedido->id); ?>" class="button button--green" target="_blank">Ver Pedido</a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
