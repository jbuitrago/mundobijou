...
class BDConsulta {
    ...
    static public function consulta($nombre_consulta, $valores = array(), $errores = null, $cache = null) {
        ...
        if ($tardanza > 5) {
            ReporteErrores::error(__FILE__, __LINE__, 'base', $archivo, $nombre_consulta, $obtengo_query, $tardanza);
        }
