...
class ArmadoCaptcha {
    ...
    public function mostrar($class = null, $estilo = null) {
        // muestra la imagen
        ...
        return "<a href=\"#\" onclick=\"document.getElementById('captcha_" . $this->_formulario . "').src = '/index.php?kk_captcha=captcha&formulario=" . $this->_formulario . "&sid=' + Math.random(); return false\"><img src=\"/index.php?kk_captcha=captcha&formulario=" . $this->_formulario . "&sid=" . md5(uniqid(time())) . "\" id=\"captcha_" . $this->_formulario . "\" border=\"0\"" . $class . $estilo . "/></a>";
    }
