...
class Componentes_DesplegableNumeros_ComponenteInsercion {
    ...
    private function _insertarConfiguracion() {
        ...
        if ($_GET['accion'] == 'ComponenteAltaInsercion') {
            ...
            $this->_tbCampoAnterior = $componente_carga->tbCampoAnterior();
            // se obtiene nombre de campo en tabla anterior
        ...
        if ($_POST['totales_mostrar'] != $this->_pv['totales_mostrar']) {
            $componente_carga->consultaParametro($id_componente, 'totales_mostrar', Bases_InyeccionSql::consulta($_POST['totales_mostrar']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'totales_mostrar');
        }
        ...
        if ($_POST['minimo'] != $this->_pv['minimo']) {
            $componente_carga->consultaParametro($id_componente, 'minimo', Bases_InyeccionSql::consulta($_POST['minimo']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'minimo');
        }
        if ($_POST['maximo'] != $this->_pv['maximo']) {
            $componente_carga->consultaParametro($id_componente, 'maximo', Bases_InyeccionSql::consulta($_POST['maximo']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'maximo');
        }
        if ($_POST['intervalo'] != $this->_pv['intervalo']) {
            $componente_carga->consultaParametro($id_componente, 'intervalo', Bases_InyeccionSql::consulta($_POST['intervalo']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'intervalo');
        }
        ...
        if ($_POST['valor_predefinido'] != $this->_pv['valor_predefinido']) {
            $componente_carga->consultaParametro($id_componente, 'valor_predefinido', Bases_InyeccionSql::consulta($_POST['valor_predefinido']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'valor_predefinido');
        }
