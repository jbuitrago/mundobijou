...
<div class="contenido_separador"></div>
<div class="contenido_margen"></div>
<div class="contenido_titulo">{TR|o_eliminar_los_archivos_al_quitar_el_componente}</div>
<div class="contenido_1"><input name="eliminar_archivos" type="radio" value="s" {PL|ea_s}>{TR|o_si}</div>
<div class="contenido_6"><input name="eliminar_archivos" type="radio" value="n" {PL|ea_n}>{TR|o_no}</div>
<div class="contenido_margen"></div>
