...
class Componentes_ArchivoDirectorio_RegistroExportar extends Armado_Plantilla {
    ...
    private function _xml() {
        ...
        return '    <' . $this->_titulo . '><![CDATA[' . $this->_valor . ']]></' . strtolower(str_replace(' ', '_', $this->_titulo)) . '>' . "\n";
    }
