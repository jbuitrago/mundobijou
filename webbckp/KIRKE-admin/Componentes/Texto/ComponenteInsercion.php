...
class Componentes_Texto_ComponenteInsercion {
    ...
    private function _insertarConfiguracion() {
        ...
        if ($tabla_tipo == 'registros') {
            ...
            $componente_carga->crearModificarColumna($tabla_nombre, $this->_tbCampo, $tb_campo_anterior, $this->_pv['tipo_dato'], $_POST['largo'], $es_nulo);
        ...
        if ($_POST['largo'] != $this->_pv['largo']) {
            $componente_carga->consultaParametro($id_componente, 'largo', Bases_InyeccionSql::consulta($_POST['largo']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'largo');
        }
        ...
        if ($_POST['permite_html'] != $this->_pv['permite_html']) {
            $componente_carga->consultaParametro($id_componente, 'permite_html', Bases_InyeccionSql::consulta($_POST['permite_html']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'permite_html');
        }
        if ($_POST['caracteres_permitidos'] != $this->_pv['caracteres_permitidos']) {
            $componente_carga->consultaParametro($id_componente, 'caracteres_permitidos', Bases_InyeccionSql::consulta($_POST['caracteres_permitidos']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'caracteres_permitidos');
        }
        ...
        if ($_POST['link_mail'] != $this->_pv['link_mail']) {
            $componente_carga->consultaParametro($id_componente, 'link_mail', Bases_InyeccionSql::consulta($_POST['link_mail']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'link_mail');
        }
        if ($_POST['link_url'] != $this->_pv['link_url']) {
            $componente_carga->consultaParametro($id_componente, 'link_url', Bases_InyeccionSql::consulta($_POST['link_url']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'link_url');
        }
