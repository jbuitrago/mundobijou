...
<div class="contenido_7"><input type="text" name="largo" id="largo" size="3" value="{PL|largo}" maxlength="3" no_nulo="{TR|o_debe_ingresar_un_dato}" filtro="numeros" max="200" /> {TR|o_valor_maximo_200} <div class="VC_error" id="VC_largo"></div></div>
<div class="contenido_margen"></div>
...
<div id="opciones_avanzadas">
    ...
    <div class="contenido_margen"></div>
    <div class="contenido_titulo">{TR|o_caracteres_permitidos} </div>
    <div class="contenido_7"><input type="text" name="caracteres_permitidos" id="caracteres_permitidos" size="30" value="{PL|caracteres_permitidos}" /> </div>
    <div class="contenido_margen"></div>
