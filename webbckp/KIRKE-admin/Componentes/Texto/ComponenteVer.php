...
class Componentes_Texto_ComponenteVer extends Armado_Plantilla {
...
// metodos de acciones
    ...
    private function _armado() {
        ...
        if ($this->_dcp['permite_html'] == 's') {
            $plantilla['ph_n'] = '';
            $plantilla['ph_s'] = 'checked="checked"';
        } else {
            $plantilla['ph_n'] = 'checked="checked"';
            $plantilla['ph_s'] = '';
        }
        ...
        if ($this->_dcp['link_mail'] == 's') {
            $plantilla['lkm_n'] = '';
            $plantilla['lkm_s'] = 'checked="checked"';
        } else {
            $plantilla['lkm_n'] = 'checked="checked"';
            $plantilla['lkm_s'] = '';
        }
        if ($this->_dcp['link_url'] == 's') {
            $plantilla['lku_n'] = '';
            $plantilla['lku_s'] = 'checked="checked"';
        } else {
            $plantilla['lku_n'] = 'checked="checked"';
            $plantilla['lku_s'] = '';
        }
        ...
        $plantilla['caracteres_permitidos'] = $this->_dcp['caracteres_permitidos'];

        $plantilla['etiqueta'] = Generales_EtiquetaIdiomasComponenteVer::get($this->_dcp);
        $plantilla['largo'] = $this->_dcp['largo'];
