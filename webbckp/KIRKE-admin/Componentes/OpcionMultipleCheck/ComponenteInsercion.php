...
class Componentes_OpcionMultipleCheck_ComponenteInsercion {
    ...
    private $_id_intermedia_tb_prefijo; // prefijo de la tabla creada especialmente para la relacion
    private $_pv;
    ...
    public function set() {
        ...
        if (isset($_POST['nombre_tabla_relacion'])) {
            $this->_intermedia_tb_nombre = $_POST['nombre_tabla_relacion'];
        }
        $this->_id_intermedia_tb_prefijo = $_POST['tabla_prefijo'];

        // controla si la tabla ya existe
        $tabla_existente = Consultas_Tabla::RegistroConsulta(__FILE__, __LINE__, $this->_intermedia_tb_nombre, $this->_id_intermedia_tb_prefijo);
        if ($tabla_existente != '') {
        ...
        $id_prefijo_array = Consultas_MatrizPrefijos::armado($this->_id_intermedia_tb_prefijo);
        $this->_intermedia_tb_prefijo = $id_prefijo_array[0]['prefijo'];
    ...
    private function _insertarConfiguracion() {
        ...
        if ($_GET['accion'] == 'ComponenteAltaInsercion') {
            ...
            Consultas_TablaCrear::armado(__FILE__, __LINE__, $this->_intermedia_tb_nombre, $this->_intermedia_tb_prefijo);

            $tabla_intermedia = $this->_intermedia_tb_prefijo . '_' . $this->_intermedia_tb_nombre;
            ...
            $id_insertado = Consultas_Tabla::RegistroCrear(__FILE__, __LINE__, $this->_id_intermedia_tb_prefijo, $orden[0]['orden'] + 1, $this->_intermedia_tb_nombre, 's', 'componente');
