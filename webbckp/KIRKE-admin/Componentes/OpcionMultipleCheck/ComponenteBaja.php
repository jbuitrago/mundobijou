...
class Componentes_OpcionMultipleCheck_ComponenteBaja {
    ...
    public function get() {
        ...
        Consultas_RegistroEliminar::armado(__FILE__, __LINE__, 'kirke_tabla', 'id_tabla', $this->_dcp['intermedia_tb_id']);
