...
<div class="contenido_7"><input type="text" name="largo" id="largo" size="2" value="{PL|largo}" maxlength="2" no_nulo="{TR|o_debe_ingresar_un_dato}" filtro="numeros" max="30" /> {TR|o_valor_maximo_30} <div class="VC_error" id="VC_largo"></div></div>
<div class="contenido_margen"></div>
<div class="contenido_titulo">{TR|o_decimales}</div>
<div class="contenido_7"><input type="text" name="decimales" id="decimales" size="1" value="{PL|decimales}" maxlength="1" no_nulo="{TR|o_debe_ingresar_un_dato}" filtro="numeros" max="8" /> {TR|o_valor_maximo_8} <div class="VC_error" id="VC_decimales"></div></div>
<div class="contenido_margen"></div>
