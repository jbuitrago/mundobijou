...
class Componentes_Fecha_ComponenteInsercion {
    ...
    private function _insertarConfiguracion() {
        ...
        if ($_POST['formato_fecha'] != $this->_pv['formato_fecha']) {
            $componente_carga->consultaParametro($id_componente, 'formato_fecha', Bases_InyeccionSql::consulta($_POST['formato_fecha']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'formato_fecha');
        }
        ...
        if ($_POST['fecha_actual'] != $this->_pv['fecha_actual']) {
            $componente_carga->consultaParametro($id_componente, 'fecha_actual', Bases_InyeccionSql::consulta($_POST['fecha_actual']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'fecha_actual');
        }
        if ($_POST['mostrar_hora'] != $this->_pv['mostrar_hora']) {
            $componente_carga->consultaParametro($id_componente, 'mostrar_hora', Bases_InyeccionSql::consulta($_POST['mostrar_hora']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'mostrar_hora');
        }
