...
class Componentes_Fecha_ComponenteVer extends Armado_Plantilla {
...
// metodos de acciones
    ...
    private function _armado() {
        ...
        switch ($this->_dcp['formato_fecha']) {
            case 'ddmmaaaa':
                $plantilla['formato_ddmmaaaa_s'] = 'checked="checked"';
                break;
            case 'ddmmaa':
                $plantilla['formato_ddmmaa_s'] = 'checked="checked"';
                break;
            case 'mmddaaaa':
                $plantilla['formato_mmddaaaa_s'] = 'checked="checked"';
                break;
            case 'mmddaa':
                $plantilla['formato_mmddaa_s'] = 'checked="checked"';
                break;
            case 'aaaammdd':
                $plantilla['formato_aaaammdd_s'] = 'checked="checked"';
                break;
            case 'aammdd':
                $plantilla['formato_aammdd_s'] = 'checked="checked"';
                break;
        }
        ...
        if ($this->_dcp['fecha_actual'] == 's') {
            $plantilla['a_n'] = '';
            $plantilla['a_s'] = 'checked="checked"';
        } else {
            $plantilla['a_n'] = 'checked="checked"';
            $plantilla['a_s'] = '';
        }
        if ($this->_dcp['mostrar_hora'] == 's') {
            $plantilla['h_n'] = '';
            $plantilla['h_s'] = 'checked="checked"';
        } else {
            $plantilla['h_n'] = 'checked="checked"';
            $plantilla['h_s'] = '';
        }
