...
<div class="contenido_margen"></div>
<div class="contenido_titulo">{TR|o_fecha_actual}</div>
<div class="contenido_1"><input name="fecha_actual" type="radio" value="s" {PL|a_s} /> {TR|o_si}</div>
<div class="contenido_6"><input name="fecha_actual" type="radio" value="n" {PL|a_n} /> {TR|o_no}</div>
<div class="contenido_margen"></div>
<div class="contenido_titulo">{TR|o_mostrar_hora}</div>
<div class="contenido_1"><input name="mostrar_hora" type="radio" value="s" {PL|h_s} /> {TR|o_si}</div>
<div class="contenido_6"><input name="mostrar_hora" type="radio" value="n" {PL|h_n} /> {TR|o_no}</div>
...
<div id="opciones_avanzadas">
    ...
    <div class="contenido_7"><input name="formato_fecha" type="radio" value="ddmmaaaa" {PL|formato_ddmmaaaa_s} />
        ...
        <input name="formato_fecha" type="radio" value="aaaammdd" {PL|formato_aaaammdd_s} />
        {TR|n_a}{TR|n_a}{TR|n_a}{TR|n_a}-{TR|n_m}{TR|n_m}-{TR|n_d}{TR|n_d}<br>
