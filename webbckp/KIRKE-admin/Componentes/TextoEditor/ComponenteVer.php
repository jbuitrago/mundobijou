...
class Componentes_TextoEditor_ComponenteVer extends Armado_Plantilla {
...
// metodos de acciones
    ...
    private function _armado() {
        ...
        if ($this->_dcp['menu'] == 'b') {
            $plantilla['m_b'] = 'checked="checked"';
            $plantilla['m_n'] = '';
            $plantilla['m_c'] = '';
        } elseif ($this->_dcp['menu'] == 'c') {
            $plantilla['m_b'] = '';
            $plantilla['m_n'] = '';
            $plantilla['m_c'] = 'checked="checked"';
        } else {
            $plantilla['m_b'] = '';
            $plantilla['m_n'] = 'checked="checked"';
            $plantilla['m_c'] = '';
        }
