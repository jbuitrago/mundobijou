...
class Componentes_FechaSistema_ComponenteInsercion {
    ...
    private function _insertarConfiguracion() {
        ...
        if ($tb_tipo == 'registros') {
            $componente_carga->crearModificarColumna($tb_nombre, $this->_tbCampo, $tb_campo_anterior, $this->_pv['tipo_dato'], $this->_pv['largo']);
