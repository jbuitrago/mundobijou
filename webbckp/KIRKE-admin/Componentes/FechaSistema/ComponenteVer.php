...
class Componentes_FechaSistema_ComponenteVer extends Armado_Plantilla {
...
// metodos de acciones
    ...
    private function _armado() {
        ...
        if ($this->_dcp['tipo'] == 'alta') {
            $plantilla['tp_m'] = '';
            $plantilla['tp_a'] = 'checked="checked"';
            $plantilla['tp_am'] = '';
        } elseif ($this->_dcp['tipo'] == 'modificacion') {
            $plantilla['tp_m'] = 'checked="checked"';
            $plantilla['tp_a'] = '';
            $plantilla['tp_am'] = '';
        } else {
            $plantilla['tp_m'] = '';
            $plantilla['tp_a'] = '';
            $plantilla['tp_am'] = 'checked="checked"';
        }
