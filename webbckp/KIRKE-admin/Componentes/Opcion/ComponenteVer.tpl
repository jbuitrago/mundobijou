...
<div class="contenido_margen"></div>
<div class="contenido_titulo">{TR|o_activado}</div>
<div class="contenido_1"><input name="activado" type="radio" value="s" {PL|act_s}>{TR|o_si}</div>
<div class="contenido_6"><input name="activado" type="radio" value="n" {PL|act_n}>{TR|o_no}</div>
<div class="contenido_margen"></div>
