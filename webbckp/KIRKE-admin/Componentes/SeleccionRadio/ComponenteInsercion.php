...
class Componentes_SeleccionRadio_ComponenteInsercion {
    ...
    private function _insertarConfiguracion() {
        ...
        if ($_GET['accion'] == 'ComponenteAltaInsercion') {
            ...
            $this->_tbCampo = 'id_' . $this->_dcp_origen['tb_prefijo'] . '_' . $this->_dcp_origen['tb_nombre'] . $sufijo;
            ...
            if ($tb_tipo == 'registros') {
                $componente_carga->crearModificarColumna($tb_nombre, $this->_tbCampo, $tb_campo_anterior, $this->_pv['tipo_dato'], 12, true, true);
            ...
            if ($sufijo != '_' . $_dcp_param[0]['valor']) {
                ...
                // agregar o modificar columna en tabla 'tipo registro' o 'tipo variable'
                if ($tb_tipo == 'registros') {
                    $componente_carga->crearModificarColumna($tb_nombre, $tb_campo_nvo, $_dcp[0]['tabla_campo'], $this->_pv['tipo_dato'], 12, true, true);
                } elseif ($tb_tipo == 'variables') {
        ...
        if ($_POST['link_a_grupo'] != $this->_pv['link_a_grupo']) {
            $componente_carga->consultaParametro($id_componente, 'link_a_grupo', Bases_InyeccionSql::consulta($_POST['seleccionar_alta']));
        } elseif ($_GET['accion'] == 'ComponenteModificacionInsercion') {
            $componente_carga->consultaParametroEliminar($id_componente, 'link_a_grupo');
        }
