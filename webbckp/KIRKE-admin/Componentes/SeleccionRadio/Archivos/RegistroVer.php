...
class DesplegableMultiple_Archivos_XmlDesplegables {
    ...
    private function set() {
        ...
        $this->_datos = Generales_LlamadoAComponentesYTraduccion::armar('RegistroVer', 'consultaAjax', $valor . '_' . $tipo, $this->_datosComponente, $this->_datosComponente['cp_nombre'], $this->_idComponente);
    }
