...
<div class="contenido_7"><input type="text" name="campo" id="caracteres_permitidos" value="{PL|campo}" filtro="abcdefghijklmnopqrstuvwxyz0123456789_" /> {TR|o_campos_iguales} </div>
<div class="contenido_separador"></div>
<div class="contenido_margen"></div>
<div class="contenido_titulo">{TR|o_motrar_nombre_de_tabla}</div>
<div class="contenido_1"><input name="motrar_nombre_tabla" type="radio" value="s" {PL|mnt_s} /> {TR|o_si}</div>
<div class="contenido_6"><input name="motrar_nombre_tabla" type="radio" value="n" {PL|mnt_n} /> {TR|o_no}</div>
<div class="contenido_separador"></div>
<div class="contenido_margen"></div>
...
<div id="opciones_avanzadas">
    ...
    <div class="contenido_7"><input type="text" name="autofiltro_elementos" id="caracteres_permitidos" size="3" value="{PL|autofiltro_elementos}" filtro="0123456789" /> </div>
    <div class="contenido_margen"></div>
    <div class="contenido_solo_titulo">{TR|o_filtro_por_antiguedad}</div>
    <div class="contenido_margen"></div>
    <div class="contenido_titulo">{TR|o_antiguedad}</div>
    <div class="contenido_7"><input type="text" name="filtrar_antiguedad" id="caracteres_permitidos" value="{PL|filtrar_antiguedad}" filtro="0123456789," /> ({TR|m_formato})</div>
    <div class="contenido_margen"></div>
