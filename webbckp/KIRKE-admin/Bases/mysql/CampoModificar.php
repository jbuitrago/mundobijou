...
class Bases_CampoModificar {
    ...
    public function campo_nuevo($campo_nuevo) {
    ...
    public function realizarConsulta() {
        ...
        // armo la consulta
        $consulta = "ALTER TABLE `" . $this->_tabla . "` CHANGE `" . $this->_campo . "` " . Bases_Campo__atributos::armado($this->_campoNuevo, $this->_tipo, $this->_largo, $this->_nulo, $this->_incremental, $this->_esIndice, $this->_campo) . ";";
