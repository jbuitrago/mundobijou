...
<div class="navbar navbar-default navbar-fixed-top yamm" role="navigation" id="navbar" > 
        ...
        <div class="collapse clearfix" id="search" style="text-align: center;">
          <form class="navbar-form" role="search">
            <div class="input-group">
              <input type="text" class="form-control" placeholder="Buscá en Mundo Bijou">
  ...
  <!-- FIN TOP BAR -->
  <div class="container">
    <div class="navbar-header"> <a class="navbar-brand home" href="{#link/index}"> <img src="img/logo.png" alt="Mundo Bijou"> <span class="sr-only">Mundo Bijou Home</span> </a> 
                  ...
                  <div class="col-sm-3 hidden-xs">
                    <div id="carousel-a" class="carousel slide carousel-sync" data-ride="carousel" data-pause="false">
                      <div class="carousel-inner">
                        <div class="item active"> <img src="img/productos/anillos/6533.jpg"> </div>
                        <div class="item"> <img src="img/productos/anillos/10028.jpg"> </div>
                        <div class="item"> <img src="img/productos/anillos/12136.jpg"> </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-3">
